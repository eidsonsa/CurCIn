			...
			while (repetidor) {
				...
				if (codigoRegistro == 0) {
					...
					if (cRCantina == 1) {
						...
						System.out.println("1 - Imprimir dados de alguma cantina especifica");
						System.out.println("2 - Manipular alguma cantina especifica");
...
//			System.out.println(x.getMessage());
//		}
//		catch (CursoNaoExistenteException x) { 
//			System.out.println(x.getMessage());
//		}
