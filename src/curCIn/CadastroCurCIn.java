...
public class CadastroCurCIn {
	...
	public Cantina nomeCantina(String nome) throws CantinaNaoExistenteException {
	...
	public void inserirCurso(Curso curso) throws CursoExistenteException, CursoNaoExistenteException{
